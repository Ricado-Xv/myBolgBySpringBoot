...
/*下面的数据,密码字段对应的是123456的md5加密后的数据*/
insert  into `tb_admin_user`(`admin_user_id`,`login_user_name`,`login_password`,`nick_name`,`locked`) values (1,'admin','e10adc3949ba59abbe56e057f20f883e','李嘉图',0);
