...
import com.my.blog.blogdemo.config.Constants;
...
import com.my.blog.blogdemo.util.MyBlogUtils;
import com.my.blog.blogdemo.util.PageQueryUtil;
import com.my.blog.blogdemo.util.Result;
import com.my.blog.blogdemo.util.ResultGenerator;
...
public class BlogController {
    ...
    public String edit(HttpServletRequest request,@PathVariable("blogId") Long blogId){
        ...
        if(blog == null) return "error/error_400";
